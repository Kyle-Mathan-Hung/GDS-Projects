...
- Ran a Location-Allocation analysis using 6,000+ historical fire calls as demand points to compare three scenarios: Base Case (16 stations), Scenario AB (+Elmira), and Scenario BA (+New Hamburg).
